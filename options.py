...
parser.add_argument('--scale_max', type=int, default=3, help='scaling noise in [scale_min, scale_max]')
parser.add_argument('--scale_min', type=int, default=0.5, help='scaling noise in [scale_min, scale_max]')
