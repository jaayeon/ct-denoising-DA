...
def load_config(opt):
    ...
    if opt.target == 'lp-mayo':
        ...
        opt.gt_img_dir = r'../../data/denoising/test/phantom/{}/{}/{}_???'.format(opt.target, opt.anatomy[0], opt.mA_full)
        opt.img_dir = r'../../data/denoising/test/phantom/{}/{}/{}_???'.format(opt.target, opt.anatomy[0], opt.mA_low)
    return opt
