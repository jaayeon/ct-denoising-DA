    ...
    for img_idx, path in enumerate(zip(img_list,gt_img_list),1):
        if img_idx % 4 :
            ...
            with torch.no_grad(): #(b,c,h,w) or (1,1,h,w)
                ...
                residual_noise = input_tensor - out_tensor
                real_out_tensor  = out_tensor - residual_noise

                #real_out_tensor = 2 * out_tensor - input_tensor
            ...
            if opt.test_patches:
                ...
                out_img_tensor = real_out_tensor
