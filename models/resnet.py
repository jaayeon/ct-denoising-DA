...
class ResNet(nn.Module):
    def __init__(self, num_input_channels = 1, num_output_channels = 50, num_blocks = 10, num_channels = 64, need_residual=True, act_fun='LeakyReLU', need_sigmoid=True, norm_layer=nn.BatchNorm2d, pad='reflection'):
        '''
