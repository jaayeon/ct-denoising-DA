...
class BaseOptions():
    ...
    def __init__(self):
        ...
        self.checkpoints_dir = os.path.join(self.dataroot, 'checkpoints-da')
    ...
    def initialize(self, parser):
        ...
        # model
        parser.add_argument('--model', type=str, default='unetda',
            choices=[
                'unetda',
                'edsr',
                'netrev'
        ...
        # dataset parameters
        parser.add_argument('--dataA', type=str, nargs='+', default=['phantom'],
            help='A dataset[mayo|lp-mayo|piglet]')
        parser.add_argument('--dataB', type=str, nargs='+', default=['mayo'],
            help='A dataset[mayo|lp-mayo| piglet]')
    ...
    def parse(self):
        ...
        if self.is_train:
            ...
            opt.test_results_dir = os.path.join(opt.data_dir, 'test-results-da', os.path.basename(opt.savedir))
